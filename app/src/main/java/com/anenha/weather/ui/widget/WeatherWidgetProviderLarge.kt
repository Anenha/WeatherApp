...
class WeatherWidgetProviderLarge : BaseWidgetProvider() {

    override fun initComponent() {
        setLayout(R.layout.widget_large, R.layout.widget_large_transparent)
        setThisWidgetClass(WeatherWidgetProviderLarge::class.java)
    }
