...
class WeatherWidgetProviderLarge : AppWidgetProvider(), WeatherServiceCallback {
    ...
    override fun onUpdate(context: Context, appWidgetManager: AppWidgetManager,
        ...
        // Get all ids
        val thisWidget = ComponentName(context, WeatherWidgetProviderLarge::class.java)
        allWidgetIds = appWidgetManager.getAppWidgetIds(thisWidget)

        val resId = if(Prefs.isTransparentMode(context)){
            R.layout.layout_widget_large_transparent
        } else {
            R.layout.layout_widget_large
        }
