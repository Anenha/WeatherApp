...
class WeatherWidgetProviderMedium : AppWidgetProvider(), WeatherServiceCallback {
    ...
    override fun onUpdate(context: Context, appWidgetManager: AppWidgetManager,
        ...
        // Get all ids
        val thisWidget = ComponentName(context, WeatherWidgetProviderMedium::class.java)
        allWidgetIds = appWidgetManager.getAppWidgetIds(thisWidget)

        val resId = if(Prefs.isTransparentMode(context)){
            R.layout.layout_widget_medium_transparent
        } else {
            R.layout.layout_widget_medium
        }
